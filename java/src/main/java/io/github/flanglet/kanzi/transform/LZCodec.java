...
public final class LZCodec implements ByteTransform {
    ...
    /**
     * <p>
     * Creates a new {@link LZCodec} instance. The default implementation uses
     * LZXCodec.
     * </p>
     *
     * @see LZXCodec
     ...
     *
     * @param ctx
     *            A map of parameters to configure the LZ codec.
     * @see LZXCodec
     */
     ...
     *
     * @param array
     *            The byte array containing the sequences.
     * @param srcIdx
     *            The starting index of the first sequence.
     * @param dstIdx
     *            The starting index of the second sequence.
    ...
    static final class LZXCodec implements ByteTransform {
         ...
         *
         * @param ctx
         *            A map of parameters to configure the LZX codec.
         */
         ...
         *
         * @param block
         *            The byte array to write the length to.
         * @param idx
         *            The starting index in the block.
         * @param length
         *            The length to emit.
         ...
         *            The starting index of the second sequence.
         * @param maxMatch
         *            The maximum length to check for a match.
         ...
         *            The starting index in the destination array.
         * @param len
         *            The number of literals to emit.
         */
    ...
    static final class LZPCodec implements ByteTransform {
         ...
         *
         * @param ctx
         *            A map of parameters to configure the LZP codec.
         */
        {
            this.hashes = new int[0];
            int bsVersion = 6;

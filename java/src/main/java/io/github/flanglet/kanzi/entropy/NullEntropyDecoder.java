...
/**
 * <p>
 * Null entropy decoder. This decoder does not perform any actual decompression;
 * it simply reads the data directly from the provided {@link InputBitStream}.
 * </p>
 *
 * <p>
...
public final class NullEntropyDecoder implements EntropyDecoder {
     ...
     *
     * @param bitstream
     *            The {@link InputBitStream} to read data from.
     ...
     * <p>
     * This method reads {@code count} bytes from the bitstream into the provided
     * {@code block} array.
     * </p>
     * 
     * @param block

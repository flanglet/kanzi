 ...
 *
 * <p>
 * This class is thread-safe and can be used with multiple concurrent
 * tasks for decompression. The compression format is identified by a unique
 * bitstream type ("KANZ") and supports multiple versions and transformations.
 * </p>
 *
...
public class CompressedInputStream extends InputStream {
    ...
    *
    * <p>
    * The first byte read is stored into element <code>array[0]</code>, the
    ...
    *
    * <p>
    * The <code>read(array)</code> method for class <code>InputStream</code>
    ...
    * {@link Listener#processEvent(Event)}
    * method is called with the provided event. Any exceptions thrown by the
    * listeners are caught
    ...
    * parallel
    * processing of multiple blocks. Each task handles the transformation and
    * entropy
    ...
    * context
    * for processing the block. The actual decoding logic is executed by the
    * {@link #call()} method.
    * </p>
    * 
    * @see SliceByteArray
   ...
   static class DecodingTask implements Callable<Status> {
       ...
       * @param oBuffer          The output buffer where the decompressed data will be
       *                         written.
       ...
       * @param listeners        Array of listeners to notify during the decoding
       *                         process.
       * @param ctx              A map containing the context information for
       *                         decoding.
       */
       ...
       * {@link #call()}
       * method should be extended or modified to implement the block decoding
       * functionality.
       * </p>
       *
    ...
    * about
    * the decoded block, including the block ID, the number of decoded bytes, the
    * checksum,

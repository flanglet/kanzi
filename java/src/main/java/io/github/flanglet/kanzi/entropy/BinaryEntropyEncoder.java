 ...
 * probability of the next bit. The prediction is provided by a {@link Predictor} instance.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This encoder is designed to work with a {@link Predictor} to adaptively encode binary data.
 * </p>
 */
public class BinaryEntropyEncoder implements EntropyEncoder {
   ...
   * <p>
   * The encoder is initialized with an {@link OutputBitStream} to write compressed data and a
   * {@link Predictor} to provide probability estimates for encoding bits.
   * </p>
   *
   ...
   * <p>
   * This method reads data from the provided byte array, encodes it using the binary entropy model,
   * and writes the compressed data to the internal bitstream.
   * </p>
   *

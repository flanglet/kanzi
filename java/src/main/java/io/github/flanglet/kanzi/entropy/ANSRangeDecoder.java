 ...
 * For an alternate C implementation example, see
...
public class ANSRangeDecoder implements EntropyDecoder {
    ...
    *
    * @param frequencies A 2D array to store the decoded frequencies for each
    *                    context and symbol.
    * @param alphabet    An array to store the decoded alphabet.
    * @return The total size of the alphabet across all contexts.
    * @throws BitStreamException If an invalid bitstream is encountered (e.g.,
    *                            incorrect range, frequency, or alphabet size).
    */

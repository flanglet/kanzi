...
/**
 * A utility wrapper for an {@link InputBitStream} that provides debugging functionality by printing
 * the bits read from the delegate bitstream. This class employs the decorator design pattern to
 * enhance the behavior of the original bitstream.
 * <p>
...
public final class DebugInputBitStream implements InputBitStream {
  ...
  /**
   * Constructs a DebugInputBitStream that writes to the standard output with a default width of 80
   * characters.
   *
  ...
  /**
   * Constructs a DebugInputBitStream that writes to the specified PrintStream with a default width
   * of 80 characters.
   *
   * @param bitstream the underlying InputBitStream to be decorated
  ...
  /**
   * Constructs a DebugInputBitStream that writes to the specified PrintStream and allows for a
   * custom width.
   *
   * @param bitstream the underlying InputBitStream to be decorated
   * @param out the PrintStream to write debug output

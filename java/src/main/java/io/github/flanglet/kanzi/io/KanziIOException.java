...
/**
 * Custom exception class that extends {@link java.io.IOException}. This exception includes an error
 * code to provide more specific information about the nature of the I/O error that occurred.
 */
public class KanziIOException extends java.io.IOException {
  ...
  /**
   * Constructs a new {@code KanziIOException} with the specified detail message and error code.
   *

 ...
 * A Lyndon word is a string that is strictly smaller than any of its non-trivial suffixes. This
 * class splits a string into Lyndon words based on the Chen-Fox algorithm.
 *
 * <p>
...
public class LyndonWords {
   ...
   *
   * <p>
   * This method uses the Chen-Fox algorithm to find the breakpoints where the string can be split
   * into Lyndon words. It is not thread-safe.
   * </p>
   *
   ...
   *
   * @param s the input string to be split
   * @param cs the charset to use for encoding the string, or {@code null} to use the default
   *        encoding
   * @return an array of Lyndon words
   */
  ...
  /**
   * Returns the positions of the breakpoints in the input string using the default character
   * encoding.
   *
  ...
  /**
   * Returns the positions of the breakpoints in the input string using the specified character
   * encoding.
   *
   * @param s the input string to be analyzed
   * @param cs the charset to use for encoding the string, or {@code null} to use the default
   ...
   *
   * <p>
   * This method demonstrates the use of the {@code split} method to split a string into Lyndon
   * words.
   * </p>
   *

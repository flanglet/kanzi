...
public class ANSRangeEncoder implements EntropyEncoder {
    ...
    /**
     * The default log range for the ANS encoder. This value determines the
     ...
     *
     * @param bs
     *            The OutputBitStream to write compressed data to.
     */
     ...
     *            The size of data chunks to process.
     * @param logRange
     *            The log range for the ANS model. This value determines the
     ...
     *
     * @param frequencies
     *            A 2D array containing the frequencies for each context and symbol.
     * @param lr
     *            The log range for the ANS model.
     ...
     * @param alphabet
     *            The alphabet (symbols present in the data).
     * @param frequencies
     *            The frequencies of the symbols.
     * @param lr
     *            The log range used for the ANS model.

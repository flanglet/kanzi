...
import io.github.flanglet.kanzi.SliceIntArray;
...
public class SA_IS {
    ...
    private static void sortLMSSuffixes(SliceIntArray src, int[] sa, SliceIntArray C, SliceIntArray B, int n, int k) {
        // compute sal
        if (C == B)
            getCounts(src, C, n, k);
    ...
    private static void induceSuffixArray(SliceIntArray src, int[] sa, SliceIntArray buf1, SliceIntArray buf2, int n,
            int k) {
        // compute sal
        if (buf1 == buf2)
    ...
    private static int computeBWT(SliceIntArray data, int[] sa, SliceIntArray iia1, SliceIntArray iia2, int n, int k) {
        // compute sal
        if (iia1 == iia2)
    ...
    public static int computeSuffixArray(SliceIntArray data, int[] sa, int fs, int n, int k, boolean isBWT) {
        SliceIntArray C;
        SliceIntArray B;
        int flags;

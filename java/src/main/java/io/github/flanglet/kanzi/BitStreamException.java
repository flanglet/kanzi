...
/**
 * This class represents exceptions specific to bit stream operations. It provides different error
 * codes to identify various error conditions.
 */
public class BitStreamException extends RuntimeException {
  ...
  /**
   * Constructs a {@code BitStreamException} with the specified detail message and error code.
   *
  ...
  /**
   * Constructs a {@code BitStreamException} with the specified detail message, cause, and error
   * code.
   *
   * @param message the detail message
  ...
  /**
   * Constructs a {@code BitStreamException} with the specified cause and error code.
   *
   * @param cause the cause
   * @param code the error code
   */

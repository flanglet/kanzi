...
public final class RangeEncoder implements EntropyEncoder {
    ...
    /**
     * The default log range for the range encoder. This value determines the
    ...
    /**
     * Creates a new {@code RangeEncoder} with the specified output bitstream and a
     * default chunk size and log range.
     *
     * @param bitstream
    ...
    /**
     * Creates a new {@code RangeEncoder} with the specified output bitstream, chunk
     * size, and log range. The chunk size indicates how many bytes are encoded (per
     * block) before resetting the frequency statistics.
     *
     * @param bs
     *            The {@link OutputBitStream} to write compressed data to.
     * @param chunkSize
     ...
     * @param logRange
     *            The log range for the range encoder. This value determines the
     *            precision of the frequency table. Must be in the range [8, 16].
     * @throws NullPointerException
     *             if {@code bs} is {@code null}.
     * @throws IllegalArgumentException
     *             if {@code chunkSize} or {@code logRange} is out of range.
     */
    ...
    /**
     * Updates the frequencies and cumulative frequencies for the current chunk, and
     * encodes the header into the bitstream.
     *
     * @param frequencies
     *            An array containing the frequencies of symbols.
     * @param size
     *            The total number of symbols in the chunk.
     * @param lr
     *            The log range for the current chunk.
    ...
    /**
     * Encodes the header of a data chunk, which includes the alphabet, frequencies,
     * and log range.
     *
     * @param alphabetSize
     *            The size of the alphabet (number of unique symbols).
     * @param alphabet
     *            An array containing the symbols in the alphabet.
     * @param frequencies
     *            An array containing the frequencies of symbols.
     * @param lr
     *            The log range used for the current chunk.

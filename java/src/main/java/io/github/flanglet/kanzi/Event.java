...
/**
 * This class represents events that occur during compression and decompression processes. Each
 * event includes attributes such as type, size, hash, and timestamp.
 */
public class Event {

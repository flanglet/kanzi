...
/**
 * This class defines constants representing magic numbers for various file types and provides
 * methods to identify file types based on their magic numbers.
 */
public class Magic {
  ...
  private static final int[] KEYS32 = {GIF_MAGIC, PDF_MAGIC, ZIP_MAGIC, LZMA_MAGIC, PNG_MAGIC,
      ELF_MAGIC, MAC_MAGIC32, MAC_CIGAM32, MAC_MAGIC64, MAC_CIGAM64, ZSTD_MAGIC, BROTLI_MAGIC,
      CAB_MAGIC, RIFF_MAGIC, FLAC_MAGIC, XZ_MAGIC, KNZ_MAGIC, RAR_MAGIC};

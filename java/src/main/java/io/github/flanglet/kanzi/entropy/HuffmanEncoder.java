...
/**
 * <p>
 * Implementation of a static Huffman encoder. This class encodes symbols into
 * a bitstream using Huffman codes, which are variable-length codes optimized
...
public class HuffmanEncoder implements EntropyEncoder {
   ...
   /**
    * Creates a new {@code HuffmanEncoder} with the specified output bitstream
    ...
    * @throws BitStreamException if an error occurs during bitstream operations or
   ...
   /**
    * First phase of the in-place calculation of minimum-redundancy codes.
    * This method computes the sums of frequencies for internal nodes.
    *
   ...
   /**
    * Second phase of the in-place calculation of minimum-redundancy codes.
    * This method assigns code lengths to symbols based on the results of phase 1.
    *
    * @param data An array containing intermediate results from phase 1 (will be
    *             modified).

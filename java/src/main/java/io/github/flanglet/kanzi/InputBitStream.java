...
/**
 * The {@code InputBitStream} interface defines methods for reading bits from a bit stream.
 */
public interface InputBitStream {
   ...
   *
   * @return {@code false} if the bitstream is closed or the end of the stream has been reached,
   *         {@code true} otherwise
   */

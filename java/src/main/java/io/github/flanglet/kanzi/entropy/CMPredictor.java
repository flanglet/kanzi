...
/**
 * <p>
 * Implementation of a Context Model based predictor. This predictor estimates
 * the probability of the next bit being 1 based on a combination of different
 * contexts and adaptive learning rates.
 * </p>
 *
 * <p>
 * It uses multiple probability counters that are updated based on the actual
 * decoded bit, allowing it to adapt to the characteristics of the input data.
 * </p>
 */
public class CMPredictor implements Predictor {
     ...
     *
     * @param ctx
     *            A map containing context information for the predictor, e.g.,
     *            "bsVersion" to specify the bitstream version.
     */
     ...
     * learning rates. The context is also updated for the next prediction.
     * </p>
     *
     * @param bit
     *            The actual bit that was decoded (0 or 1).
     */
    @Override
     ...
     * split point in a range coding scheme.
     * </p>
     *

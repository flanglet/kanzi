...
public class Memory {
    ...
    /**
     * The {@code BigEndian} class provides methods for reading and writing data in
     * big-endian format.
     */
    public static class BigEndian {
        ...
        public static int readInt16(byte[] buf, int offset) {
            return ((buf[offset + 1] & 0xFF) << SHIFT16_1) | ((buf[offset] & 0xFF) << SHIFT16_0);
        }
    ...
    /**
     * The {@code LittleEndian} class provides methods for reading and writing data
    ...
    public static class LittleEndian {
        ...
        /**
         * Reads a 64-bit long value from the specified byte array in little-endian
         * order.
         *
         * @param buf
         *            the byte array
         ...
         */
        public static long readLong64(byte[] buf, int offset) {
            return ((((long) buf[offset + 7]) & 0xFF) << SHIFT64_0) | ((((long) buf[offset + 6]) & 0xFF) << SHIFT64_1)
                    ...
                    | ((((long) buf[offset + 1]) & 0xFF) << SHIFT64_6) | ((((long) buf[offset]) & 0xFF) << SHIFT64_7);
        }

        /**
         * Reads a 32-bit int value from the specified byte array in little-endian
         * order.
         *
         * @param buf
         *            the byte array
         ...
         */
        public static int readInt32(byte[] buf, int offset) {
            return ((buf[offset + 3] & 0xFF) << SHIFT32_0) | ((buf[offset + 2] & 0xFF) << SHIFT32_1)
                    | ((buf[offset + 1] & 0xFF) << SHIFT32_2) | ((buf[offset] & 0xFF) << SHIFT32_3);
        }

        /**
         * Reads a 16-bit int value from the specified byte array in little-endian
         * order.
         *
         * @param buf
         *            the byte array
         ...
         */
        public static int readInt16(byte[] buf, int offset) {
            return ((buf[offset + 1] & 0xFF) << SHIFT16_0) | ((buf[offset] & 0xFF) << SHIFT16_1);
        }

        /**
         * Writes a 64-bit long value to the specified byte array in little-endian
         * order.
         *
         * @param buf
         *            the byte array

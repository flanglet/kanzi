...
/**
 * The {@code Memory} class provides utility methods for reading and writing data in big-endian and
 * little-endian formats, regardless of the CPU's native endianness.
 */
public class Memory {
  ...
  /**
   * The {@code BigEndian} class provides methods for reading and writing data in big-endian format.
   */
  ...
  /**
   * The {@code LittleEndian} class provides methods for reading and writing data in little-endian
   * format.
   */

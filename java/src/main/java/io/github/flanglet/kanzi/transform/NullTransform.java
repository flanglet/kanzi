...
/**
 * NullTransform is a no-op transform that simply copies the input to the output without performing
 * any modifications.
 */
public class NullTransform implements ByteTransform {
  ...
  /**
   * Performs the forward transform, which in this case is a no-op copy from the input to the
   * output.
   *
  ...
  /**
   * Performs the inverse transform, which in this case is a no-op copy from the input to the
   * output.
   *
   * @param input the input byte array
   * @param output the output byte array
  ...
  /**
   * Returns the maximum encoded length, which is the same as the source length for this no-op
   * transform.
   *

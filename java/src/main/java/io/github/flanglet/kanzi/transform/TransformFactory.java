...
/**
 * Factory class to create instances of ByteTransform based on their type. Supports up to 64
...
public class TransformFactory {
  ...
  /**
   * Up to 64 transforms can be declared (6 bit index). Represents the 'none' or 'copy' transform.
   */

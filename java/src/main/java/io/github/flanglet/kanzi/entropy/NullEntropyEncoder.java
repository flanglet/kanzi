...
/**
 * <p>
 * Null entropy encoder. This encoder does not perform any actual compression; it simply writes the
 * data directly to the provided {@link OutputBitStream}.
 * </p>
 *
 * <p>
 * It acts as a pass-through mechanism, useful when no entropy coding is applied to the data, or
 * when the data is already in its final form.
 * </p>
 */
public final class NullEntropyEncoder implements EntropyEncoder {
   ...
   * 
   * @param bitstream The {@link OutputBitStream} to write data to.
   ...
   * <p>
   * This method writes {@code count} bytes from the provided {@code block} array to the bitstream.
   * </p>
   * 

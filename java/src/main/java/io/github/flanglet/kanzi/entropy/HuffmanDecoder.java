...
public class HuffmanDecoder implements EntropyDecoder
{
   ...
   public int decodeV5(byte[] block, int blkptr, int count)
   {
   ...
   public int decodeV6(byte[] block, int blkptr, int count)
   {
   ...
   public boolean decodeChunk(byte[] block, int blkptr, int count)
   {
      ...
      while (n < szFrag - 4)
      {
         ...
         state0 = (state0 << shift0) | (Memory.BigEndian.readLong64(this.buffer, idx0) >>> (63-shift0) >>> 1); // handle shift = 0
         state1 = (state1 << shift1) | (Memory.BigEndian.readLong64(this.buffer, idx1) >>> (63-shift1) >>> 1); // handle shift = 0
         state2 = (state2 << shift2) | (Memory.BigEndian.readLong64(this.buffer, idx2) >>> (63-shift2) >>> 1); // handle shift = 0
         state3 = (state3 << shift3) | (Memory.BigEndian.readLong64(this.buffer, idx3) >>> (63-shift3) >>> 1); // handle shift = 0
         ...
         final int val00 = this.table[(int)(state0>>bs0) & TABLE_MASK_V4]; bs0 -= (val00>>>8);
         final int val10 = this.table[(int)(state1>>bs1) & TABLE_MASK_V4]; bs1 -= (val10>>>8);
         final int val20 = this.table[(int)(state2>>bs2) & TABLE_MASK_V4]; bs2 -= (val20>>>8);
         final int val30 = this.table[(int)(state3>>bs3) & TABLE_MASK_V4]; bs3 -= (val30>>>8);
         final int val01 = this.table[(int)(state0>>bs0) & TABLE_MASK_V4]; bs0 -= (val01>>>8);
         final int val11 = this.table[(int)(state1>>bs1) & TABLE_MASK_V4]; bs1 -= (val11>>>8);
         final int val21 = this.table[(int)(state2>>bs2) & TABLE_MASK_V4]; bs2 -= (val21>>>8);
         final int val31 = this.table[(int)(state3>>bs3) & TABLE_MASK_V4]; bs3 -= (val31>>>8);
         final int val02 = this.table[(int)(state0>>bs0) & TABLE_MASK_V4]; bs0 -= (val02>>>8);
         final int val12 = this.table[(int)(state1>>bs1) & TABLE_MASK_V4]; bs1 -= (val12>>>8);
         final int val22 = this.table[(int)(state2>>bs2) & TABLE_MASK_V4]; bs2 -= (val22>>>8);
         final int val32 = this.table[(int)(state3>>bs3) & TABLE_MASK_V4]; bs3 -= (val32>>>8);
         final int val03 = this.table[(int)(state0>>bs0) & TABLE_MASK_V4]; bs0 -= (val03>>>8);
         final int val13 = this.table[(int)(state1>>bs1) & TABLE_MASK_V4]; bs1 -= (val13>>>8);
         final int val23 = this.table[(int)(state2>>bs2) & TABLE_MASK_V4]; bs2 -= (val23>>>8);
         final int val33 = this.table[(int)(state3>>bs3) & TABLE_MASK_V4]; bs3 -= (val33>>>8);
      ...
      while (n < szFrag)
      {
         ...
         final int val0 = this.table[(int)(state0>>bs0) & TABLE_MASK_V4]; bs0 -= (val0>>>8);
         final int val1 = this.table[(int)(state1>>bs1) & TABLE_MASK_V4]; bs1 -= (val1>>>8);
         final int val2 = this.table[(int)(state2>>bs2) & TABLE_MASK_V4]; bs2 -= (val2>>>8);
         final int val3 = this.table[(int)(state3>>bs3) & TABLE_MASK_V4]; bs3 -= (val3>>>8);

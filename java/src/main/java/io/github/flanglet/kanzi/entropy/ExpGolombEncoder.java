 ...
 * <p>
 * This encoder supports both signed and unsigned encoding of byte values.
 * It uses a pre-computed cache for faster encoding of common values.
 */
public final class ExpGolombEncoder implements EntropyEncoder {
    ...
    * @param signed    If {@code true}, the encoder will encode signed values;
    *                  otherwise, unsigned.

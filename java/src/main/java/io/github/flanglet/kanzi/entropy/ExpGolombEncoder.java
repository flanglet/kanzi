 ...
 * <p>
 * This encoder supports both signed and unsigned encoding of byte values. It
 * uses a pre-computed cache for faster encoding of common values.
 */
public final class ExpGolombEncoder implements EntropyEncoder {
    private static final int[][] CACHE_VALUES = new int[][]{
            // Unsigned
            new int[]{513, 1538, 1539, 2564, 2565, 2566, 2567, 3592, 3593, 3594, 3595, 3596, 3597, 3598, 3599, 4624,
            ...
            // Signed
            new int[]{513, 2052, 2054, 3080, 3082, 3084, 3086, 4112, 4114, 4116, 4118, 4120, 4122, 4124, 4126, 5152,
     ...
     *
     * @param bitstream
     *            The {@link OutputBitStream} to write the encoded data to.
     * @param signed
     *            If {@code true}, the encoder will encode signed values; otherwise,
     *            unsigned.

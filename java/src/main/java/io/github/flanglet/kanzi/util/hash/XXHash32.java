...
/**
 * XXHash32 is an implementation of the 32-bit variant of the XXHash algorithm, which is a fast
 * non-cryptographic hash function. It is designed for high-speed hashing, commonly used in
 * applications where performance is critical, such as checksums, hash tables, and data integrity
 * verification. Port to Java of the original source code: https://github.com/Cyan4973/xxHash
 *
 * <p>
 * XXHash32 uses a sequence of rounds with constant mixing primes to process the input data and
 * produce a 32-bit hash value. This class allows for an optional user-defined seed, providing a
 * degree of variability in the output.
 */
public class XXHash32 {
  ...
  /**
   * Computes the 32-bit hash of the provided byte array. This method uses the entire byte array,
  ...
  /**
   * Computes the 32-bit hash of the provided byte array, with the option to specify an offset and

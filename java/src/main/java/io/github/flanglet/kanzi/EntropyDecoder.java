...
public interface EntropyDecoder {
  ...
  /**
   * Decodes the next chunk of data from the bitstream and returns it in the provided buffer.
   *
  ...
  /**
   * Releases any resources associated with this entropy decoder. This method should be called
   * before disposing of the entropy decoder.
   */
  public void dispose();

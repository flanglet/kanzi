...
/**
 * <p>
 * Implementation of an Adaptive Probability Map (APM) with fast logistic function. This class maps
 * a probability and a context into a new probability that the next bit will be 1. After each guess,

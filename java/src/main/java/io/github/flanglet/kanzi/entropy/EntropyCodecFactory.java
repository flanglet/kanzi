 ...
 * <p>
 * This class provides static methods to instantiate various entropy coding algorithms based on a
 * given type identifier or name.
 * </p>
 */
public class EntropyCodecFactory {
   ...
   * <p>
   * Each block is decoded separately, and the entropy decoder is rebuilt to reset block statistics.
   * </p>
   *
   * @param ibs The {@link InputBitStream} to read compressed data from.
   * @param ctx A map containing context information for the decoder.
   * @param entropyType The type of entropy codec to create.
   * @return A new {@link EntropyDecoder} instance.
   * @throws NullPointerException if {@code ibs} is {@code null}.
   * @throws IllegalArgumentException if the {@code entropyType} is unsupported.
   */
  public static EntropyDecoder newDecoder(InputBitStream ibs, Map<String, Object> ctx,
      int entropyType) {
    if (ibs == null)
   ...
   * <p>
   * Each block is encoded separately, and the entropy encoder is rebuilt to reset block statistics.
   * </p>
   *
   * @param obs The {@link OutputBitStream} to write compressed data to.
   * @param ctx A map containing context information for the encoder.
   * @param entropyType The type of entropy codec to create.
   * @return A new {@link EntropyEncoder} instance.
   * @throws NullPointerException if {@code obs} is {@code null}.
   * @throws IllegalArgumentException if the {@code entropyType} is unknown.
   */
  public static EntropyEncoder newEncoder(OutputBitStream obs, Map<String, Object> ctx,
      int entropyType) {
    if (obs == null)
    ...
    switch (entropyType) {
      ...
      default:
        throw new IllegalArgumentException(
            "Unknown entropy codec type: '" + (char) entropyType + "'");
    }
  }
   ...
   *
   * @param entropyType The type identifier of the entropy codec.
   ...
   *
   * @param name The name of the entropy codec (case-insensitive).
   * @return The type identifier of the entropy codec.
   * @throws IllegalArgumentException if the {@code name} is unsupported.
   */

...
public class EntropyCodecFactory {
    ...
    * <p>
    * Each block is decoded separately, and the entropy decoder is rebuilt
    * to reset block statistics.
    * </p>
    *
    ...
    * <p>
    * Each block is encoded separately, and the entropy encoder is rebuilt
    * to reset block statistics.
    * </p>
    *

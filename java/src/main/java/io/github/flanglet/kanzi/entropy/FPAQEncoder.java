...
/**
 * <p>
 * Implementation of an FPAQ encoder. This class is derived from fpaq0r by Matt Mahoney and
...
public class FPAQEncoder implements EntropyEncoder {
   ...
   * <p>
   * This method reads data from the provided byte array, encodes it using the FPAQ model, and
   ...
   * The probability model for the current context is then updated based on the encoded bit.
   * </p>
   */
   ...
   * <p>
   * This method is called when the range becomes too small and needs to be normalized. It writes
   * the most significant bits of the range to the bitstream.
   * </p>
   */
  private void flush() {

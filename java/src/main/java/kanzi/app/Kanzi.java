...
public class Kanzi
{
   ...
   private static final String APP_HEADER = "Kanzi 1.5 (C) 2019,  Frederic Langlet";
        ...
        for (String arg : args)
        {
           ...
           if (arg.equals("--help") || arg.equals("-h"))
           {
               ...
               if (mode != 'd')
               {
                  ...
                  printOut("        transform [None|BWT|BWTS|LZ|ROLZ|ROLZX|RLT|ZRLT|MTFT]", true);
                  printOut("                  [RANK|SRT|TEXT|X86]", true);

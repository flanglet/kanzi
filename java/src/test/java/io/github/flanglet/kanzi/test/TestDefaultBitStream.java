...
public class TestDefaultBitStream {
    ...
    public static boolean testSpeed1(String[] args) {
        ...
        file.deleteOnExit();
        int[] values = new int[]{3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3, 31, 14, 41, 15, 59, 92, 26, 65, 53, 35,
                58, 89, 97, 79, 93, 32};
    ...
    public static boolean testSpeed2(String[] args) {
        ...
        File file = new File(fileName);
        file.deleteOnExit();
        byte[] values = new byte[]{3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3, 31, 14, 41, 15, 59, 92, 26, 65, 53,
                35, 58, 89, 97, 79, 93, 32};
